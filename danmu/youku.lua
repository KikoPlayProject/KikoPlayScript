...
function download_seg(cna, vid, seg, danmuList)
    ...
    if not cookies or #cookies == 0 then
        cookies = get_cookies(reply["headers"]["set-cookie"])
    end
